...
def _define_module_for_target_variant_chipset(target, variant, chipset):
    ...
    if chipset == "qca6750":
        deps = [
            "//sm8650-moddules/qcom/opensource/wlan/platform:{}_icnss2".format(tv),
            "//sm8650-moddules/qcom/opensource/wlan/platform:{}_cnss_prealloc".format(tv),
            "//sm8650-moddules/qcom/opensource/wlan/platform:{}_cnss_utils".format(tv),
            "//sm8650-moddules/qcom/opensource/wlan/platform:{}_cnss_nl".format(tv),
            "//msm-kernel:all_headers",
            "//sm8650-moddules/qcom/opensource/wlan/platform:wlan-platform-headers",
            "//sm8650-moddules/qcom/opensource/dataipa:include_headers",
            "//sm8650-moddules/qcom/opensource/dataipa:{}_{}_ipam".format(target, variant),
        ]
    else:
        deps = [
            "//sm8650-moddules/qcom/opensource/wlan/platform:{}_cnss2".format(tv),
            "//sm8650-moddules/qcom/opensource/wlan/platform:{}_cnss_prealloc".format(tv),
            "//sm8650-moddules/qcom/opensource/wlan/platform:{}_cnss_utils".format(tv),
            "//sm8650-moddules/qcom/opensource/wlan/platform:{}_cnss_nl".format(tv),
            "//msm-kernel:all_headers",
